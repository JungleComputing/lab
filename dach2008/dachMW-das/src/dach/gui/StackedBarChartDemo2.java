...
public class StackedBarChartDemo2 extends ApplicationFrame {
    ...
    private CategoryDataset createDataset() {
    	...
    	DefaultCategoryDataset tmp = new DefaultCategoryDataset();
    	
    	tmp.addValue(10.0, "a", "node1");
    	tmp.addValue(8.5, "b", "node2");
    	tmp.addValue(7.9, "a", "node2");
    	tmp.addValue(8.0, "b", "node3");
    	tmp.addValue(9.5, "a", "node4");
    	tmp.addValue(5.5, "b", "node4");
