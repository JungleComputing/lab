...
public class DFSServer implements Upcall, Runnable {
	...
	public DFSServer(String root, String name) throws Exception {
		...
		if (cache != null) { 
			...
			} else if (cache.equals("SA")) { 
				// Sort by size (large to small), followed by an alphabetical order (a-z)
			}
		}*/
	}
	...
	public static void main(String [] args) { 
		...
		try {
			new DFSServer(root, name, serverAddress, hubAddresses, pool).run();
		} catch (Exception e) {
