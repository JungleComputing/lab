...
public class Master implements Upcall {
	...
	public Master(ResultProcessor processor, 
		...
		this(processor, -1, null, null, null, null,
				workerClusters, workerOptions, workerDir, dataClusters, dataDir, allowRemoteSteals, advancedQueue);
	} 
	...
	private void startWorkerClusters(List<Cluster> clusters, List<String> workerOptions, String homeDir) { 
